      ...
      <div class="panel panel-default content-main">
          <form name="question" method="post" action="/users/update">
	          ...
	          <div class="form-group">
	         	...
	         	<input id="userClass" name="userClass" type="radio" class="custom-control-input" value="USR" <c:if test="${user.userClass == 'USR'}">checked</c:if> required> 일반회원
	         	<input id="userClass" name="userClass" type="radio" class="custom-control-input" value="ADM" <c:if test="${user.userClass == 'ADM'}">checked</c:if> required> 관리자
